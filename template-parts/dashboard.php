...
<?php foreach($args['friends'] as $friend): ?><a href="<?php echo esc_url($friend->link_url); ?>" target="_blank" rel="noopener noreferrer"><?php if($friend->link_image): ?><img src="<?php echo esc_url($friend->link_image); ?>" width="28" height="28" alt="" loading="lazy"><?php else: ?><span class="feng-dash-friend-initial" aria-hidden="true"><?php echo esc_html(mb_substr($friend->link_name,0,1)); ?></span><?php endif; ?><span><?php echo esc_html($friend->link_name); ?></span></a><?php endforeach; ?>

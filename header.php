...
(function(){var root=document.documentElement,saved;try{saved=localStorage.getItem('xf-theme');}catch(e){}var configured=<?php echo wp_json_encode($feng_scheme); ?>;var setting=configured!=='system'?configured:(saved==='light'||saved==='dark'||saved==='system'?saved:'system');var dark=setting==='dark'||(setting!=='light'&&window.matchMedia('(prefers-color-scheme: dark)').matches);root.setAttribute('data-xf-theme',dark?'dark':'light');})();
</script>
<style>
...
<div class="xf-loadbar" data-xf-progress aria-hidden="true"></div>
